...
ui <- pageWithSidebar(
    ...
    sidebarPanel(
        ...
        p("...proudly presented by ",
          ...
          " applying data aggregated by ",
          a("KITmetricslab", 
            href = "https://github.com/KITmetricslab/covid19-forecast-hub-de/tree/master/data-truth/RKI/by_age/"),
        ...
        p(
          ...
          a("NFDI4Health Task Force COVID-19", href= "https://www.nfdi4health.de/de/task-force-covid-19/"), 
